...
ct_cptac_var_image <- corr.test(image1, cptac1, method='spearman', adjust='none')
write.table(t(ct_cptac_var_image$r),"cor_image_var_cptac_method2.txt",sep="\t")
dim(ct_cptac_var_image$p)
...
ct_rnaseq_var_image <- corr.test(image1, rnaseq1, method='spearman', adjust='none')
write.table(t(ct_rnaseq_var_image$r),"cor_image_var_rnaseq_method2.txt",sep="\t")
